...
" ----------------------
Plugin 'grep.vim'
nnoremap <silent> <F3> :Grep<CR>  " 光标定位到要查找的内容上，F3
" -------
" python
" -------
...
highlight Pmenu guibg=darkgrey  guifg=black    " 所有项的配色
highlight PmenuSel guibg=lightgrey guifg=black " 选中项的配色
...
source $VIMRUNTIME/ftplugin/man.vim " 内置插件
