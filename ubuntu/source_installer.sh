...
[[ ${source_count} == 1 ]] || sudo apt-fast update
# ***************************************************************
...
# oh-my-zsh
oh_my_zsh_repository=https://raw.github.com/robbyrussell/oh-my-zsh
[[ ${SHELL} != /usr/bin/zsh ]] \
&& echo ${ENV_PASSWORD} | chsh -s `which zsh` \
&& curl -L "${oh_my_zsh_repository}/master/tools/install.sh" | sh
